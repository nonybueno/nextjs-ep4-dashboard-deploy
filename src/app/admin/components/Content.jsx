...
function Content({ totalUsersData, totalPostsData }) {
  return (
    <div className='px-10 rounded-lg'>
        ...
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos sunt ex porro, tempora sapiente neque? Harum at ea maxime ipsam possimus odit voluptatem, voluptatibus perferendis ex saepe ut assumenda nam!
        </p>
    </div>
  )
}
