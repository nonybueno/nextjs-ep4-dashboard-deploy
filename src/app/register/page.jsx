                ...
                <div className='flex justify-center items-center'>
                    <div className='w-[400px] shadow-xl p-10 mt-5 rounded-xl'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <input onChange={(e)=>setName(e.target.value)} placeholder='Enter your name' type="text" className='w-full bg-gray-200 border py-2 px-3 rounded text-lg my-2'/>
                            ...
                            <input onChange={(e)=>setConfirmPassword(e.target.value)} placeholder='Confirm your password' type="password" className='w-full bg-gray-200 border py-2 px-3 rounded text-lg my-2'/>
